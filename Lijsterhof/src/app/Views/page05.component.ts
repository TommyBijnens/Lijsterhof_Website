...
export class Page05Component implements OnInit {
   ...
   // datalogService: DatalogService;
    ...
    getData(): void
    {
        this.tempGraph.push(new DatalogComponents.GraphSerieComponent(this.datalogService,this.temp1, 30, 4, "Temp 1"));
        this.tempGraph.push(new DatalogComponents.GraphSerieComponent(this.datalogService, this.temp2, 30, 4, "Temp 2"));
        this.tempGraph.push(new DatalogComponents.GraphSerieComponent(this.datalogService, this.temp3, 30, 4, "Temp 3"));
        this.tempGraph.push(new DatalogComponents.GraphSerieComponent(this.datalogService, this.tempB, 30, 4, "Temp Buffer"));
    }
