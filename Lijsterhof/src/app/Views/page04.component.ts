...
export class Page04Component implements OnInit {
   ...
   // datalogService: DatalogService;
    ...
    getData(): void
    {
        this.tempGraph.push(new DatalogComponents.GraphSerieComponent(this.datalogService,this.temp1, 30, 1, "Temp 1"));
        this.tempGraph.push(new DatalogComponents.GraphSerieComponent(this.datalogService, this.temp2, 30, 1, "Temp 2"));
        this.tempGraph.push(new DatalogComponents.GraphSerieComponent(this.datalogService, this.temp3, 30, 1, "Temp 3"));
        this.tempGraph.push(new DatalogComponents.GraphSerieComponent(this.datalogService, this.tempB, 30, 1, "Temp Buffer"));
    }
