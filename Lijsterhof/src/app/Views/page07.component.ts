...
export class Page07Component implements OnInit {
  ...
  //  datalogService: DatalogService;
    ...
    getData(): void
    {
        this.graph.push(new DatalogComponents.BarSerieComponent(this.datalogService, this.bs_h_log, 100, 12, "BS Hout"));
        this.graph.push(new DatalogComponents.BarSerieComponent(this.datalogService, this.bs_m_log, 100, 12, "BS Mazout"));
        this.graph.push(new DatalogComponents.BarSerieComponent(this.datalogService, this.t_h_log, 100, 12, "T Hout"));
        this.graph.push(new DatalogComponents.BarSerieComponent(this.datalogService, this.t_m_log, 100, 12, "T Mazout"));
