...
import { Component, NgZone, Input, ChangeDetectionStrategy, Optional, Inject } from '@angular/core';
...
/**
 * The root Linear Gauge component.
 *
 * @example
 * ```ts
...
var LinearGaugeComponent = (function (_super) {
    ...
    function LinearGaugeComponent(configurationService, themeService, intlService, ngZone, rtl) {
        return _super.call(this, configurationService, themeService, intlService, ngZone, rtl) || this;
    }
