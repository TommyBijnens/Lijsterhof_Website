...
export declare class ArcGaugeComponent extends GaugeComponent {
    ...
    constructor(changeDetector: ChangeDetectorRef, element: ElementRef, configurationService: ConfigurationService, themeService: ThemeService, intlService: IntlService, ngZone: NgZone, rtl?: boolean);
